...
const CheckoutPage = () => {
  ...
  const makePurchase = async () => {
    if (
      ...
      const response = fetch("http://${process.env.NEXT_PUBLIC_API_URL}/api/orders", {
        method: "POST",
        headers: {
  ...
  const addOrderProduct = async (
    ...
    const response = await fetch("http://${process.env.NEXT_PUBLIC_API_URL}/api/order-product", {
      method: "POST", // or 'PUT'
      headers: {
        "Content-Type": "application/json",
      },
